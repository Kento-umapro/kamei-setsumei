...
SCHEMA = {
    "is_franchise": "true/false。どてっぱんのFC加盟に関する商談・加盟説明・加盟問い合わせ・条件相談なら true。社内MTG・採用面接・取引先打合せ・無関係な会議など、加盟開発と明らかに関係ない場合のみ false。判断に迷う場合は true。",
...
# ルール
- is_franchise は最初に判定する。どてっぱんの加盟（FC）に関する商談・説明・問い合わせなら true。明らかに加盟開発と無関係な会議（社内MTG・採用面接・取引先打合せ等）のみ false。曖昧なら true。
